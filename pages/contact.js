  ...
  return (
    <div className="pt-20 min-h-screen bg-indigo-200">
      <div className="max-w-5xl mx-auto lg:px-4 pt-4 md:grid  md:grid-cols-2 gap-4 flex flex-col">
        <div className="md:col-span-2 w-full rounded  px-4 ">
        ...
        <div className="md:col-span-2  p-4 mb-4 flex  mx-auto items-center justify-center text-indigo-500 gap-4">
          <a
            className="cursor-pointer flex flex-col items-center mx-2 text-center text-xs rounded-full p-4 hover:bg-indigo-100 hover:text-red-400 transition"
        ...
        <div className="h-96 mx-4 md:mx-none shadow-xl rounded-xl overflow-hidden border-2 border-white mb-20">
          <Map />
        </div>
      </div>
      <HeroWave />
